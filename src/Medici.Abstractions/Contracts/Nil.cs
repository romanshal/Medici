...
namespace Medici.Abstractions.Contracts
{
    ...
    {
        private static readonly Nil _value = new();

        /// <summary>
        /// Default and only value of the <see cref="Nil"/> type.
        /// </summary>
        public static ref readonly Nil Value => ref _value;

        /// <summary>
        /// Task from a <see cref="Nil"/> type.
        /// </summary>
        public static Task<Nil> Task { get; } = System.Threading.Tasks.Task.FromResult(_value);
        ...
        /// </returns>
        public int CompareTo(Nil other) => 0;
        ...
        public static bool operator ==(Nil first, Nil second) => true;
        ...
        public static bool operator !=(Nil first, Nil second) => false;
